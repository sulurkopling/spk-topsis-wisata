        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <select name="jarak" class="form-select" required>
                    <option value="5">0–20 km</option>
                    <option value="4">21–40 km</option>
                    <option value="3">41–60 km</option>
                    <option value="2">61–80 km</option>
                    <option value="1">81–100 km</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="tiket" class="form-select" required>
                    <option value="5">Rp 0–10.000</option>
                    <option value="4">Rp 11.000–20.000</option>
                    <option value="3">Rp 21.000–30.000</option>
                    <option value="2">Rp 31.000–40.000</option>
                    <option value="1">Rp 41.000–50.000</option>
                </select>
            </div>
