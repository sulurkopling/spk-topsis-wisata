        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="fasilitas[]" value="Parkir" id="f1">
                    <label class="form-check-label" for="f1">Parkir</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="fasilitas[]" value="Toilet" id="f2">
                    <label class="form-check-label" for="f2">Toilet</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="fasilitas[]" value="Mushala" id="f3">
                    <label class="form-check-label" for="f3">Mushala</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="fasilitas[]" value="Penginapan" id="f4">
                    <label class="form-check-label" for="f4">Penginapan</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="fasilitas[]" value="Tempat Makan" id="f5">
...
if (isset($_POST['simpan'])) {
    ...
    // Pakai count → jumlah fasilitas
    $fasilitas_total = count($fasilitas);

    // Hapus nilai lama dulu
