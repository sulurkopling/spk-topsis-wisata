        ...
        <table class="table table-bordered table-hover mt-2">
            ...
            while ($row = $data->fetch_assoc()) {
                echo "<tr>
                    ...
                    <td>
                        <div class='d-flex'>
                            <a href='?edit={$row['id_wisata']}' class='btn btn-sm btn-warning btn-action'>Edit</a>
                            <a href='?hapus={$row['id_wisata']}' class='btn btn-sm btn-danger btn-action' onclick=\"return confirm('Hapus data ini?')\">Hapus</a>
                        </div>
                    </td>
                </tr>";
                $no++;
