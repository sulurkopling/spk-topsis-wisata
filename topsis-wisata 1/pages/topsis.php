...
if ($id !== null) {
    ...
    if (!$wisata) {
        ...
        function getLabel($kategori, $bobot) {
            $labels = [
                'Jarak' => [5=>'0–20 km', 4=>'21–40 km', 3=>'41–60 km', 2=>'61–80 km', 1=>'81–100 km'],
                'Waktu' => [5=>'Pagi – Sore', 4=>'Sore – Malam', 3=>'Siang – Sore', 2=>'24 Jam', 1=>'Pagi – Siang'],
                'Tiket' => [5=>'Rp 0–10.000', 4=>'Rp 11.000–20.000', 3=>'Rp 21.000–30.000', 2=>'Rp 31.000–40.000', 1=>'Rp 41.000–50.000'],
                'Transportasi' => [5=>'Sepeda Motor', 4=>'Mobil Pribadi', 3=>'Angkutan Umum', 2=>'Ojek', 1=>'Delman'],
                'Fasilitas' => [5=>'Parkir', 4=>'Toilet', 3=>'Mushala', 2=>'Penginapan', 1=>'Tempat Makan']
            ];
            if ($kategori == 'Fasilitas') {
                $result = [];
                foreach ($labels[$kategori] as $b => $desc) {
                    if ($bobot >= $b) $result[] = $desc;
                }
